...
* Prefer `Optional` or empty collections
* Validate inputs and fail fast
* Never allow null to propagate silently

## Collections

* Never return mutable collections from public APIs
* Prefer empty collections over `null`
* Always use defensive copies when exposing internal collections
...
* Keep APIs safe with defensive copies

...
- Always choose the simplest pattern that satisfies the requirement
...
* Logic is complex
* UI needs reuse independent of logic
...
- Provide user-visible error feedback
...
- Use hooks or service layer for all data fetching

## Immutability

- Never mutate state or server data
